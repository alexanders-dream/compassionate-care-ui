...
const TeamPage = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Merge Data
            const teamMap = new Map(teamData.map(t => [t.name.toLowerCase(), t]));
            ...
            profilesData.forEach(p => {
                const teamMem = teamMap.get((p.full_name || "").toLowerCase());
                ...
                if (teamMem) {
                    ...
                    // User exists but has no public Team Member entry yet
                    merged.push({
            ...
            setTeamMembers(teamData); // Update global cache
